<?php
  $title       = 'Web Design Wigan | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Wigan web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Wigan web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-wigan/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Wigan",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Wigan and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-wigan/",
  "areaServed": { "@type": "Place", "name": "Wigan, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Wigan", "item": "https://hellowebdesign.co.uk/web-design-wigan/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Wigan?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes - we're based in Urmston and cover Wigan. We work remotely day-to-day and come over to meet in person when it matters, whichever suits you." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Wigan, Bolton, Salford, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Wigan</span>
      <h1>Web design in Wigan, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio in Urmston, building websites for Wigan's independents and small businesses. You deal with us directly - we work remotely day-to-day and come over to meet in person when it matters.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're an Urmston studio and cover Wigan too - we work remotely day-to-day and come over to meet in person when it matters. You always deal with the people doing the work.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Wigan and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Wigan?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes - we're based in Urmston and cover Wigan. We work remotely day-to-day and come over to meet in person when it matters, whichever suits you.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Wigan, Bolton, Salford, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
...
<section class="nearby alt" aria-labelledby="nearby-h">
  <div class="wrap">
    ...
    <h2 id="nearby-h">Web design near Wigan</h2>
    <p>We're based in Urmston and cover the whole of Greater Manchester - these are the towns closest to Wigan that we also have dedicated pages for.</p>
...
<section class="cta-band" aria-labelledby="cta-h">
  <div class="wrap">
    ...
    <h2 id="cta-h">Let's build your Wigan business a website</h2>
