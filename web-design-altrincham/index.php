<?php
  $title       = 'Web Design Altrincham | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Altrincham web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Altrincham web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-altrincham/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Altrincham",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Altrincham and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-altrincham/",
  "areaServed": { "@type": "Place", "name": "Altrincham, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Altrincham", "item": "https://hellowebdesign.co.uk/web-design-altrincham/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Altrincham?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We're based just down the road in Urmston, so meeting Altrincham businesses in person is easy - it's how we get the detail right." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Altrincham, Trafford, Sale, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Altrincham</span>
      <h1>Web design in Altrincham, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio just down the road in Urmston, building websites for Altrincham's thriving scene of independents and small businesses. You deal with us directly, and we'll happily meet you in person.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're based in Urmston, a short hop from Altrincham, so we'll come and see you in person. It's easier to build the right thing when we've sat down together.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Altrincham and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Altrincham?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes. We're based just down the road in Urmston, so meeting Altrincham businesses in person is easy - it's how we get the detail right.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Altrincham, Trafford, Sale, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
...
<section class="nearby alt" aria-labelledby="nearby-h">
  <div class="wrap">
    ...
    <h2 id="nearby-h">Web design near Altrincham</h2>
    <p>We're based in Urmston and cover the whole of Greater Manchester - these are the towns closest to Altrincham that we also have dedicated pages for.</p>
...
<section class="cta-band" aria-labelledby="cta-h">
  <div class="wrap">
    ...
    <h2 id="cta-h">Let's build your Altrincham business a website</h2>
