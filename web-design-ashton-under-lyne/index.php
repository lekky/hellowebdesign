<?php
  $title       = 'Web Design Ashton-under-Lyne | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Ashton-under-Lyne web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Ashton-under-Lyne web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-ashton-under-lyne/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Ashton-under-Lyne",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Ashton-under-Lyne and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-ashton-under-lyne/",
  "areaServed": { "@type": "Place", "name": "Ashton-under-Lyne, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Ashton-under-Lyne", "item": "https://hellowebdesign.co.uk/web-design-ashton-under-lyne/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Ashton-under-Lyne?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes - we're based in Urmston and cover Ashton-under-Lyne and Tameside. We'll meet in person where it helps and work remotely where it suits." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Ashton-under-Lyne, Tameside, Oldham, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Ashton-under-Lyne</span>
      <h1>Web design in Ashton-under-Lyne, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio in Urmston, building websites for Ashton-under-Lyne's market traders and small businesses. You deal with us directly, meeting in person where it helps and working remotely where it suits.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're an Urmston studio covering Ashton-under-Lyne and Tameside - in person where it helps, remotely where it suits. Either way you deal directly with the people doing the work.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Ashton-under-Lyne and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Ashton-under-Lyne?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes - we're based in Urmston and cover Ashton-under-Lyne and Tameside. We'll meet in person where it helps and work remotely where it suits.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Ashton-under-Lyne, Tameside, Oldham, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
...
<section class="nearby alt" aria-labelledby="nearby-h">
  <div class="wrap">
    ...
    <h2 id="nearby-h">Web design near Ashton-under-Lyne</h2>
    <p>We're based in Urmston and cover the whole of Greater Manchester - these are the towns closest to Ashton-under-Lyne that we also have dedicated pages for.</p>
    <ul class="nearby-list">
      <li><a href="/web-design-oldham/">Oldham</a></li>
...
<section class="cta-band" aria-labelledby="cta-h">
  <div class="wrap">
    ...
    <h2 id="cta-h">Let's build your Ashton-under-Lyne business a website</h2>
