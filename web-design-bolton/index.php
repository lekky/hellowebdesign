<?php
  $title       = 'Web Design Bolton | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Bolton web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Bolton web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-bolton/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Bolton",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Bolton and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-bolton/",
  "areaServed": { "@type": "Place", "name": "Bolton, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Bolton", "item": "https://hellowebdesign.co.uk/web-design-bolton/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Bolton?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes - we're based in Urmston and cover Bolton. We'll meet in person for the important bits and work remotely the rest of the time, whichever suits you best." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Bolton, Bury, Salford, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Bolton</span>
      <h1>Web design in Bolton, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio in Urmston, building websites for small businesses across Bolton. You deal with us directly - the people doing the work - and we'll meet in person where it helps or work remotely where that's easier.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're an Urmston studio and cover Bolton happily - we'll meet you in person for the parts that matter and work remotely the rest of the time, whichever suits you.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Bolton and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Bolton?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes - we're based in Urmston and cover Bolton. We'll meet in person for the important bits and work remotely the rest of the time, whichever suits you best.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Bolton, Bury, Salford, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
...
<section class="nearby alt" aria-labelledby="nearby-h">
  <div class="wrap">
    ...
    <h2 id="nearby-h">Web design near Bolton</h2>
    <p>We're based in Urmston and cover the whole of Greater Manchester - these are the towns closest to Bolton that we also have dedicated pages for.</p>
    <ul class="nearby-list">
      <li><a href="/web-design-bury/">Bury</a></li>
      <li><a href="/web-design-wigan/">Wigan</a></li>
...
<section class="cta-band" aria-labelledby="cta-h">
  <div class="wrap">
    ...
    <h2 id="cta-h">Let's build your Bolton business a website</h2>
