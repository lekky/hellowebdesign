<?php
  $title       = 'Web Design Oldham | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Oldham web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Oldham web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-oldham/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Oldham",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Oldham and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-oldham/",
  "areaServed": { "@type": "Place", "name": "Oldham, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Oldham", "item": "https://hellowebdesign.co.uk/web-design-oldham/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Oldham?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes - we're based in Urmston and cover Oldham. We'll meet in person where it helps and work remotely where it's simpler, whichever suits you." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Oldham, Rochdale, Ashton-under-Lyne, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Oldham</span>
      <h1>Web design in Oldham, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio in Urmston, building websites for Oldham's independents and small businesses. You deal with us directly, meeting in person where it helps and working remotely where it's simpler.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're an Urmston studio covering Oldham across Greater Manchester - in person where it helps, remotely where it's simpler. Either way you deal directly with the people doing the work.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Oldham and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Oldham?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes - we're based in Urmston and cover Oldham. We'll meet in person where it helps and work remotely where it's simpler, whichever suits you.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Oldham, Rochdale, Ashton-under-Lyne, Manchester, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
