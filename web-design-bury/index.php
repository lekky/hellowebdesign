<?php
  $title       = 'Web Design Bury | Local Website Designers - HelloWebDesign';
  $desc        = 'Local Bury web design from a husband-and-wife studio in Urmston. We meet you in person, build the site ourselves and you deal with us directly - no account managers. Sites from £499.';
  $twitterDesc = 'Local Bury web design from a husband-and-wife studio. We meet you in person and you deal with us directly. Sites from £499.';
  $canonical   = 'https://hellowebdesign.co.uk/web-design-bury/';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Web Design Bury",
  "serviceType": "Web design",
  "description": "Local website design for small businesses across Bury and Greater Manchester - built in person by a husband-and-wife studio in Urmston. Sites from £499.",
  "url": "https://hellowebdesign.co.uk/web-design-bury/",
  "areaServed": { "@type": "Place", "name": "Bury, Greater Manchester, UK" },
  "provider": {
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Design Bury", "item": "https://hellowebdesign.co.uk/web-design-bury/" }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you meet clients in person around Bury?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We're based in Urmston and happy to come over to Bury to meet in person and talk through the project - it's how we get the detail right." }
    },
    {
      "@type": "Question",
      "name": "Which areas do you cover?",
      "acceptedAnswer": { "@type": "Answer", "text": "We work with businesses right across Greater Manchester - Bury, Bolton, Manchester, Salford, Urmston and the surrounding towns - and remotely further afield when it suits." }
    },
    {
      "@type": "Question",
...
<header class="hero">
  <div class="wrap hero-grid">
    <div>
      <span class="eyebrow">Web Design &middot; Bury</span>
      <h1>Web design in Bury, from two people who actually <em>pick up the phone</em>.</h1>
      <p class="lead">We're a husband-and-wife studio in Urmston, building websites for Bury's market traders, independents and small businesses. You deal with us directly, and we're happy to come over and meet you in person.</p>
      <div class="hero-cta">
...
<section id="why" class="alt" aria-labelledby="why-h">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-item"><span class="n">01</span><div><h3>We meet you in person</h3><p>We're based in Urmston, a straightforward run over to Bury, and we're glad to meet you in person for the important bits. It's easier to build the right thing when we've sat down together.</p></div></div>
      ...
      <div class="feat-item"><span class="n">04</span><div><h3>Big-brand experience</h3><p>20+ years working with household names, now focused entirely on local businesses around Bury and Greater Manchester.</p></div></div>
    </div>
  </div>
</section>
...
<section id="faq" aria-labelledby="faq-h">
  <div class="wrap">
    ...
    <div class="faq">
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Do you meet clients in person around Bury?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>Yes. We're based in Urmston and happy to come over to Bury to meet in person and talk through the project - it's how we get the detail right.</p></div></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">Which areas do you cover?<span class="pm"></span></button>
        <div class="faq-a"><div class="faq-a-inner"><p>We work with businesses right across Greater Manchester - Bury, Bolton, Manchester, Salford, Urmston and the surrounding towns - and remotely further afield when it suits.</p></div></div>
      </div>
      <div class="faq-item">
...
<section class="nearby alt" aria-labelledby="nearby-h">
  <div class="wrap">
    ...
    <h2 id="nearby-h">Web design near Bury</h2>
    <p>We're based in Urmston and cover the whole of Greater Manchester - these are the towns closest to Bury that we also have dedicated pages for.</p>
...
<section class="cta-band" aria-labelledby="cta-h">
  <div class="wrap">
    ...
    <h2 id="cta-h">Let's build your Bury business a website</h2>
