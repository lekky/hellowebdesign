...
<div class="pmodal" id="privacyModal" aria-hidden="true">
  ...
  <div class="pmodal-card" role="dialog" aria-modal="true" aria-labelledby="privacy-title">
    ...
    <p>We also use <a href="https://posthog.com/privacy" target="_blank" rel="noopener">PostHog</a>, an analytics tool hosted in the EU, to see which pages and buttons people actually use, and to replay how visitors move through the site so we can spot where things get confusing. These replays mask everything you type and all the text on the page, so we can see that someone got stuck on the contact form without ever seeing what they wrote. PostHog sets cookies and processes this data in line with their privacy policy.</p>
